...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #ASH  

    I make this #ASH to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: test
   ...
   I will renounce the ownership to burn addresses to transfer #ASH to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #ASH 10000000X? 
   ...
   it's the best part of the #ASH idea, increasing the liquidity pool automatically, 
...
contract AstroShibaToken is Context, IERC20, Ownable {
